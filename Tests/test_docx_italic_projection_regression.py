...
normalized_para_in_doc = doc_root.xpath("/w:document/w:body/w:p", namespaces=NS)[0]
normalized_pairs = _run_text_and_italic_flags(normalized_para_in_doc)
assert normalized_pairs, "Normalized paragraph should contain text runs."
assert not any(is_italic for _text, is_italic in normalized_pairs), normalized_pairs
