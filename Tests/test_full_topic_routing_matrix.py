...
ROUTING_CASES = [
    ...
    {
        "topic": "public_law_automated_decision_making",
        "kind": "essay",
        "prompt": essay(
            "Public Law – Automated Public Decision-Making",
            "Critically evaluate whether modern public law controls automated and data-driven public decision-making. Discuss judicial review, procedural fairness, reasons, fettering discretion, meaningful human involvement, Article 8, Article 14, UK GDPR, Data Protection Act 2018, Data (Use and Access) Act 2025, and remedies.",
        ),
    },
    {
