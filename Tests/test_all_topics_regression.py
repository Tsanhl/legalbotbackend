...
""".strip(),
    "public_law_automated_decision_making": """
4500 words
1. Public Law / Human Rights / Data Governance - Essay Question (Automated Public Decision-Making)
...
In your answer, you should:
- explain judicial review legality, rationality, procedural fairness, reasons, and fettering discretion
- assess algorithmic tools, transparency, explainability, and meaningful human involvement
- consider Article 8 ECHR, Article 14 ECHR, proportionality, UK GDPR, Data Protection Act 2018, and Data (Use and Access) Act 2025
- evaluate remedies and whether traditional judicial review is enough or statutory reform is needed
""".strip(),
