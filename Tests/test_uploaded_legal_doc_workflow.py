...
with tempfile.TemporaryDirectory() as tmp_dir:
    ...
    assert "online verification and search-backed supplementation" in amend_prompt
    assert "backend online-search context supplied by the route" in amend_prompt
